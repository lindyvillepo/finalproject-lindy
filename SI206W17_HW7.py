...
statement += 'Tweets (id INTEGER PRIMARY KEY, tweet_id INTEGER, author TEXT, time_posted TIMESTAMP, tweet_text TEXT, retweets INTEGER)'
...
tweet_info = zip(none_list, tweet_id, authors, created, text, retweets)
...
time = "SELECT time_posted FROM Tweets"
cur.execute(time)
